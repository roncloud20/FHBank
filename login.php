...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="fhbCSS/login.css">
        ...
        <div class="container">
            <form>
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" placeholder="Enter Email id"  id="exampleInputEmail1" aria-describedby="emailHelp">
